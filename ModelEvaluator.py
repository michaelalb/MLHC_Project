...
def create_results_dict(model: TorchForecastingModel, test_label_ts: list, test_cov_ts: list,
                        output_path: str,
                        should_save: bool = True) -> dict:
    """
...
def evaluate_model(model_name: str, train_test_data_pickle_file_name: str,
                   evaluation_results_output_path: str) -> dict:
    """
    ...
    base_label_path: str = "./Evaluation/label_directory"
    base_pred_path: str = "./Evaluation/prediction_directory"
...
if __name__ == '__main__':
    evaluate_model(model_name='model_V3_CPU_2023_08_27_15_24_22.pt',
                   train_test_data_pickle_file_name="ffill_ts_train_test.pkl",
                   evaluation_results_output_path="./ffill_ts_train_test_results.pkl")
